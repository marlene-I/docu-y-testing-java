...
@Validated
public interface InscriptosApi {

    @Operation(summary = "Obtener listado de socios por actividad", description = "", tags={  })
    @ApiResponses(value = { 
    ...
    @RequestMapping(value = "/inscriptos/{nombreActividad}",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
    ResponseEntity<List<Socio>> inscriptosNombreActividadGet(@Parameter(in = ParameterIn.PATH, description = "Nombre de la actividad", required=true, schema=@Schema()) @PathVariable("nombreActividad") String nombreActividad
);
